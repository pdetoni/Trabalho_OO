...
//        Consulta consulta6 = new Consulta(6, "Dematologista");
        ...
        Paciente = persistencia.lerArquivoPaciente("src/main/java/Classes/Data/pacientes.txt");
        Consulta = persistencia.lerArquivoConsulta("src/main/java/Classes/Data/consulta.txt");
//        Agenda = persistencia.lerArquivoAgenda("src/main/java/Classes/Data/agenda.txt");
        ...
        Agenda Agenda3 = null;
        try {
            Agenda1 = new Agenda(1, "22/12/2023 14:30", Paciente.get(3), Consulta.get(0));
            Agenda2 = new Agenda(2, "18/12/2023 09:30", Paciente.get(2), Consulta.get(3));
            Agenda3 = new Agenda(3, "14/12/2023 07:30", Paciente.get(0), Consulta.get(2));
